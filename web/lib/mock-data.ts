...
const ALL_ROWS: OverviewPayload["leadCases"] = [
  ...
  { id: "CO-2024-GDA-145", score: 83, riskBand: "high", entity: "GOBERNACIÓN DEL CHOCÓ", provider: "COMUNIDADES ASOCIADAS DEL ATRATO SAS", department: "CHOCO", modality: "Contratación directa", date: "2024-07-08", value: 2_930_000_000, valueLabel: "", secopUrl: "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=24-1-241876", pickReason: "", signal: "", factors: [] },
  { id: "CO-2024-COR-GJR-078", score: 77, riskBand: "high", entity: "GOBERNACIÓN DE CÓRDOBA", provider: "INGENIERÍA TROPICAL S.A.", department: "CORDOBA", modality: "Selección abreviada", date: "2024-09-30", value: 4_120_000_000, valueLabel: "", secopUrl: "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=24-1-271345", pickReason: "", signal: "", factors: [] },
  { id: "CO-2024-SAF-CESAR-199", score: 71, riskBand: "high", entity: "GOBERNACIÓN DEL CESAR", provider: "ALIANZA VIAL DEL CARIBE S.A.S.", department: "CESAR", modality: "Contratación directa", date: "2024-12-02", value: 3_780_000_000, valueLabel: "", secopUrl: "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=24-1-311892", pickReason: "", signal: "", factors: [] },
  { id: "CO-2025-VIC-013", score: 74, riskBand: "high", entity: "GOBERNACIÓN DEL VICHADA", provider: "SERVICIOS RURALES INTEGRADOS LTDA.", department: "VICHADA", modality: "Contratación directa", date: "2025-01-17", value: 1_230_000_000, valueLabel: "", secopUrl: "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=25-1-039841", pickReason: "", signal: "", factors: [] },
  { id: "CO-2025-COL-MAG-033", score: 66, riskBand: "medium", entity: "GOBERNACIÓN DEL MAGDALENA", provider: "OPERADORES INTEGRALES DEL NORTE S.A.", department: "MAGDALENA", modality: "Selección abreviada", date: "2025-01-09", value: 2_560_000_000, valueLabel: "", secopUrl: "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=25-1-034218", pickReason: "", signal: "", factors: [] },
  { id: "CO-2024-SENA-302", score: 61, riskBand: "medium", entity: "SERVICIO NACIONAL DE APRENDIZAJE — SENA", provider: "SOLUCIONES EDUCATIVAS INTEGRALES S.A.", department: "ATLANTICO", modality: "Selección abreviada", date: "2024-09-18", value: 2_180_000_000, valueLabel: "", secopUrl: "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=24-1-267834", pickReason: "", signal: "", factors: [] },
  { id: "CO-2025-ICBF-077", score: 58, riskBand: "medium", entity: "INSTITUTO COLOMBIANO DE BIENESTAR FAMILIAR", provider: "OPERADORES SOCIALES DEL PACÍFICO LTDA.", department: "VALLE DEL CAUCA", modality: "Contratación directa", date: "2025-01-30", value: 1_740_000_000, valueLabel: "", secopUrl: "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=25-1-041272", pickReason: "", signal: "", factors: [] },
  { id: "CO-2024-NARC-067", score: 63, riskBand: "medium", entity: "GOBERNACIÓN DE NARIÑO", provider: "CONSTRUCTORA ANDINA DEL SUR S.A.S.", department: "NARINO", modality: "Licitación pública", date: "2024-11-12", value: 5_870_000_000, valueLabel: "", secopUrl: "https://www.contratos.gov.co/consultas/detalleProceso.do?numConstancia=24-1-291234", pickReason: "", signal: "", factors: [] },
...
function mockEdge(
  ...
  return {
    ...
    typeDescription: `${contractor} recibió ${count} contrato${count > 1 ? "s" : ""} de ${entity} por un total de ${formatMockCurrency(monto)}.`,
    confidence,
    confidenceBand: band as "high" | "medium" | "low",
    confidenceLabel: bandLabel,
    total_monto: monto,
    total_monto_label: formatMockCurrency(monto),
...
export function getMockNetwork(): NetworkPayload {
  const n = (id: string, label: string, type: "entity" | "provider", value: number, degree: number, hhi: number | null, isHub = false) => ({
    ...
    degree,
    total_value: value,
    total_value_label: formatMockCurrency(value),
    mean_risk: 0.55,
    max_risk: 0.82,
    herfindahl: hhi,
