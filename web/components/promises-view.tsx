...
const PARTY_COLORS: Record<string, string> = {
  ...
  petro_2018: "#3cb7ff",
  fajardo_2018: "#8fdc7a",
  angelica_lozano_2018: "#72d9a0",
  gustavo_bolivar_2018: "#ff9f1c",
  juanita_goebertus_2018: "#a0c4ff",
  katherine_miranda_2018: "#5de2a5",
  cepeda_2026: "#ff9f1c",
  valencia_2026: "#6fa8ff",
  lopez_2026: "#78d7c4",
  espriella_2026: "#ff7b7b",
  roy_barreras_2026: "#c8a2ff",
  lizcano_2026: "#7be8ff",
  murillo_2026: "#5de2a5",
  fajardo_2026: "#e9bd54",
  clara_lopez_2026: "#ff9f7c",
  miguel_uribe_2026: "#ffb347",
  caicedo_2026: "#70c8ff",
  sondra_macollins_2026: "#c895ff",
  santiago_botero_2026: "#88e0a0",
  matamoros_2026: "#ff8fa0",
};
...
const WIKIPEDIA_PAGES: Record<string, string> = {
  ...
  "gustavo-petro-gov": "Gustavo_Petro",
  ...
  "wilson_arias": "Wilson_Arias_Castillo",
  "ariel_avila": "Ariel_%C3%81vila",
  duque_2018: "Iv%C3%A1n_Duque_M%C3%A1rquez",
  petro_2018: "Gustavo_Petro",
  fajardo_2018: "Sergio_Fajardo",
  angelica_lozano_2018: "Ang%C3%A9lica_Lozano",
  gustavo_bolivar_2018: "Gustavo_Bol%C3%ADvar",
  juanita_goebertus_2018: "Juanita_Goebertus",
  katherine_miranda_2018: "Katherine_Miranda",
  ...
  roy_barreras_2026: "Roy_Barreras",
  lizcano_2026: "Mauricio_Lizcano",
  fajardo_2026: "Sergio_Fajardo",
};
...
const LEGISLATIVE_SPOTLIGHTS: ReferenceCard[] = [
  ...
  {
    id: "gustavo-petro-gov",
    name: "Gustavo Petro",
    role: "Presidencia",
    period: "2022-2026",
    chamber: "executive",
    party: "Pacto Histórico",
    promiseQuote: "”Cambio de modelo productivo, transición energética justa y paz total con todos los actores armados.”",
    outcomeQuote: "El periodo registra avance en diálogos de paz, tensiones en reformas estructurales y una agenda social amplia con ejecución parcial.",
    sourceLabel: "Plan Nacional de Desarrollo 2022-2026",
    sourceUrl: "https://www.dnp.gov.co/Plan-Nacional-de-Desarrollo/Paginas/PND-2022-2026.aspx",
    outcomeLabel: "DNP / informes de gestión",
    outcomeUrl: "https://www.dnp.gov.co/",
    note: "El caso central del ciclo activo: mide coherencia entre el programa de campaña más ambicioso en décadas y la ejecución institucional real.",
  },
  {
    id: "francia-marquez",
    ...
    chamber: "executive",
    party: "Pacto Histórico",
    promiseQuote: "”Buen vivir, justicia ambiental y derechos de los pueblos afrodescendientes e indígenas.”",
    outcomeQuote: "El registro visible combina gestión del Ministerio de Igualdad, agenda ambiental territorial y posicionamiento internacional en foros climáticos.",
    sourceLabel: "Ministerio de Igualdad y Equidad",
    sourceUrl: "https://www.minigualdad.gov.co/",
    outcomeLabel: "Gestión visible 2022-2026",
    outcomeUrl: "https://www.minigualdad.gov.co/",
    note: "Útil para leer la promesa de representación interseccional desde el cargo y cuánta autonomía programática se materializa en política pública.",
  },
  {
    id: "inti-asprilla",
    name: "Inti Asprilla",
    ...
    chamber: "house",
    party: "Alianza Verde",
    promiseQuote: "”Democracia digital, regulación de plataformas y transparencia en datos públicos.”",
    outcomeQuote: "Su huella visible incluye proyectos sobre regulación tecnológica y debates sobre derechos digitales desde la Cámara.",
    sourceLabel: "Cámara de Representantes",
    sourceUrl: "https://www.camara.gov.co/",
    outcomeLabel: "Actividad legislativa visible",
    outcomeUrl: "https://www.camara.gov.co/",
    note: "Permite leer cómo maduran promesas técnicas sobre tecnología pública cuando pasan al proceso legislativo.",
  },
  {
    id: "rodrigo-lara",
    name: "Rodrigo Lara",
    ...
    chamber: "house",
    party: "Cambio Radical",
    promiseQuote: "”Reforma al sistema de salud desde la sostenibilidad fiscal y el acceso real a los usuarios.”",
    outcomeQuote: "Su posición en el debate de reforma a la salud quedó documentada con ponencias, debate en comisión y oposición técnica pública.",
    sourceLabel: "Cámara de Representantes",
    sourceUrl: "https://www.camara.gov.co/",
    outcomeLabel: "Actividad legislativa visible",
    outcomeUrl: "https://www.camara.gov.co/",
    note: "Es un buen referente para ver cómo la oposición técnica a una reforma grande genera huella parlamentaria verificable.",
  },
  {
    id: "paloma-valencia",
    ...
    chamber: "senate",
    party: "Centro Democrático",
    promiseQuote: "”Oposición fundamentada, defensa de la estabilidad fiscal y vigilancia a la ejecución del gobierno.”",
    outcomeQuote: "El registro visible de este ciclo incluye debates de control político, proposiciones y actividad legislativa documentada en el Senado.",
    sourceLabel: "Senado de la República",
    sourceUrl: "https://www.senado.gov.co/",
    outcomeLabel: "Actividad legislativa visible",
    outcomeUrl: "https://www.senado.gov.co/",
    note: "Perfil relevante para comparar cómo la promesa de oposición deja rastro en el registro legislativo oficial.",
  },
  {
    id: "wilson_arias",
    name: "Wilson Arias",
    ...
    chamber: "senate",
    party: "Pacto Histórico",
    promiseQuote: "”Control al poder económico concentrado, defensa de bienes comunes y fiscalización al sector privado.”",
    outcomeQuote: "Su rastro visible incluye debates fuertes sobre monopolios, denuncias de concentración empresarial y proyectos de democratización económica.",
    sourceLabel: "Senado de la República",
    sourceUrl: "https://www.senado.gov.co/",
    outcomeLabel: "Actividad legislativa visible",
    outcomeUrl: "https://www.senado.gov.co/",
    note: "Permite rastrear cómo promesas antimonopolio se traducen en investigaciones, proyectos y exposición pública documentada.",
  },
  {
    id: "ariel_avila",
    name: "Ariel Ávila",
    ...
    chamber: "house",
    party: "Alianza Verde",
    promiseQuote: "”Paz territorial, reforma rural y reducción de violencia con enfoque de datos y política pública.”",
    outcomeQuote: "El período acumula debates sobre paz, proyectos de reforma rural y publicaciones técnicas que respaldan su perfil legislativo.",
    sourceLabel: "Cámara de Representantes",
    sourceUrl: "https://www.camara.gov.co/",
    outcomeLabel: "Actividad legislativa visible",
    outcomeUrl: "https://www.camara.gov.co/",
    note: "Es un caso útil donde la promesa de experto en seguridad se puede contrastar con producción legislativa y agenda pública verificable.",
  },
];
